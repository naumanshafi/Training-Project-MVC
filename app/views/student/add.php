...
<body>
<h1 style="text-align: center; margin-top: 100px">Add Student </h1>
<form style="text-align: center" name = "form1" method="post">
    <div class = "container">
        <table style="align-content: center;margin-left: auto; margin-right: auto; margin-top: 50px">
            <input type = "hidden" name = "getcontroller" value = "studentController" required/>
            ...
            <tr>
                ...
                <td>
                    <input style="margin-left: 48px" type = "text" name = "major" value = "" required/>
                </td>
            </tr>
        </table>
